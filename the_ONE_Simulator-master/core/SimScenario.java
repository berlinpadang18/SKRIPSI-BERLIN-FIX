...
public class SimScenario implements Serializable {
    ...
    protected void createHosts() {
        ...
        for (int i = 1; i <= nrofGroups; i++) {
            ...
            for (int j = 0; j < nrofHosts; j++) {
                ...
                host.setNationality(RandomNationlity());
                host.setLanguages(RandomLanguages());
                host.setAffiliation(RandomAffiliation());
                host.setCountry(RandomCountry());
                
                System.out.println("node : " + host.toString() + " (" + host.getNationality() + ")");
                System.out.println("node : " + host.toString() + " (" + host.getLanguages() + ")");
                System.out.println("node : " + host.toString() + " (" + host.getAffiliation() + ")");
                System.out.println("node : " + host.toString() + " (" + host.getCountry() + ")");
    ...
    public Integer RandomNationlity(){
        Random an = new Random();
        int angka = an.nextInt(4);
        return angka + 1;
    }
    
    public Integer RandomLanguages(){
        Random an = new Random();
        int angka = an.nextInt(4);
        return angka + 1;
    }
    
    public Integer RandomAffiliation(){
        Random an = new Random();
        int angka = an.nextInt(4);
        return angka + 1;
    }
    
    public Integer RandomCountry(){
        Random an = new Random();
        int angka = an.nextInt(4);
        return angka + 1;
    }
